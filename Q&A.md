...
## 2. What is 'Dimension Curse'? How to prevent?
...
## 5. Metrics you will use to evaluate model performance and tell the advantage for each of them. (F score, ROC curve, recall, etc…)
...
## 8. Why doesn't logistic regression use R^2 and MSE?
...
## 10. Linear Regression Basic Assumptions
...
Multicollinearity: Independent variables should not be highly correlated with each other, inflates the standard errors of the coefficients, leads to unstable and unreliable coefficient estimates
...
Use when the effect of one independent variable on the dependent variable depends on the level of another independent variable. By including interaction terms, you can capture more nuanced relationships between variables that wouldn't be detected with just the main effects.


## 12. What is SVM? what parameters you will need to tune during model training? 
...
## 14. Please briefly describe the Random Forest classifier. How did it work? Any pros and cons in practical implementation?
...
## 15. Please describe the difference between GBM tree model and Random Forest.
...
- Remove
- Imputation: mode, average, neighbor values, predict
